                    ...
                    <div className="row justify-content-between g-lg-4 gy-5">
                        <div className="col-lg-3 col-md-8 col-sm-6 col-12">
                            <AnimatedFooterMenu>
                                ...
                                <a href='tel:+12345-678-91012' className="contact-number">(+12) 345-678-91012</a>
                                <p>75 Arlington St. Suite 500 Boston, MA 02116, USA.</p>
                                <ul className="social-network social-circle">
                                    <li><a href="#" title="Facebook">Fb.</a></li>
                                    <li><a href="#" title="Twitter">Tw.</a></li>
                                    <li><a href="#" title="Youtube">Be.</a></li>
                                    <li><a href="#" title="Skype">Yt.</a></li>
                                </ul>
                            </AnimatedFooterMenu>
                        </div>
                        <div className="col-lg-2 col-md-4 col-sm-6 col-6 ">
                            <AnimatedFooterMenu>
                                ...
                                <ul className="footer-menu-list">
                                    <li><a href="#" className="foot-link">Marketing</a></li>
                                    <li><a href="#" className="foot-link">Product Design</a></li>
                                    <li><a href="#" className="foot-link">Web Design</a></li>
                                    <li><a href="#" className="foot-link">Development</a></li>
                                </ul>
                            </AnimatedFooterMenu>
                        </div>
                        <div className="col-lg-2 col-md-4 col-sm-6 col-6">
                            <AnimatedFooterMenu>
                                ...
                                <ul className="footer-menu-list">
                                    <li><a href="#" className="foot-link">IT Colsulting</a></li>
                                    <li><a href="#" className="foot-link">About Us</a></li>
                                    <li><a href="#" className="foot-link">Latest Blogs</a></li>
                                    <li><a href="#" className="foot-link">Contact Us</a></li>
                                </ul>
                            </AnimatedFooterMenu>
                        </div>
                        <div className="col-lg-2 col-md-4 col-sm-6 col-6">
                            <AnimatedFooterMenu>
                                ...
                                <ul className="footer-menu-list">
                                    <li><a href="#" className="foot-link">Help</a></li>
                                    <li><a href="#" className="foot-link">Support</a></li>
                                    <li><a href="#" className="foot-link">Clients</a></li>
                                    <li><a href="#" className="foot-link">Contacts</a></li>
                                </ul>
                            </AnimatedFooterMenu>
                        </div>
                        <div className="col-lg-2 col-md-4 col-sm-6 col-6">
