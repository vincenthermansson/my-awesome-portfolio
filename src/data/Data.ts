...
const trainingProgramData = [
  ...
  },
  {
    id: 4,
    title: "Zumba",
    img: "img/training-program-4.png",
  },
  {
    id: 5,
    title: "Yoga",
    img: "img/training-program-5.png",
  },
  {
    id: 6,
    title: "Crossfit",
...
const featureData = [
  {
    id: 1,
    img: "img/camera.png", // camera icon — suits Photography / Frontend Dev (visual)
    title: "Front-end Development",
    text: "Crafting beautiful, responsive user interfaces with React and modern web technologies.",
  },
  {
    id: 2,
    img: "img/photograph.png", // photograph icon — suits Backend / API
    title: "Back-end Development",
    text: "Building robust and scalable server-side applications and APIs with Node.js and Django.",
  },
  {
    id: 3,
    img: "img/eye.png", // eye icon — suits Monitoring or Testing or Code Review
    title: "Code Quality & Testing",
    text: "Ensuring high-quality code with automated testing, code reviews, and best practices.",
  },
  {
    id: 4,
    img: "img/l1.png", // lighting icon — suits DevOps or Automation (brightening things)
    title: "DevOps & Automation",
    text: "Streamlining deployment and infrastructure with CI/CD pipelines and cloud automation.",
  },
  {
    id: 5,
    img: "img/arial.png", // aerial photo icon — suits Cloud Architecture or Infrastructure overview
    title: "Cloud Architecture",
    text: "Designing scalable and secure cloud solutions on AWS and Google Cloud Platform.",
  },
  {
    id: 6,
    img: "img/l2.png", // color grading icon — suits Performance or Optimization
    title: "Performance Optimization",
    text: "Optimizing applications for speed, scalability, and smooth user experiences.",
  },
];
...
const projectData = [
  {
    ...
    titleCategory: "Backend Development",
  ...
  },
  {
    ...
    titleCategory: "Frontend Development",
    category: ["frontend"],
  },
  {
    id: 3,
    img: "img/project/p5_3.jpg",
    title: "Cloud Migration on GCP",
    titleCategory: "Cloud Infrastructure",
  ...
  },
  {
    ...
    titleCategory: "Fullstack Development",
  ...
  },
  {
    ...
    titleCategory: "Quality Assurance",
...
const blogData6 = [
  {
    id: 1,
    title: "Building Scalable Microservices with Node.js and PostgreSQL",
    img: "/img/pc_blog1.webp",
    date: "01 March 2025",
    content: {
      intro:
        "In this comprehensive guide, we dive into designing and implementing scalable microservices architectures using Node.js and PostgreSQL. Discover how to break down monoliths, manage data consistency, and optimize performance to support enterprise-grade applications.",
      sections: [
        {
          title: "Understanding Microservices Architecture",
          text:
            "Microservices split large applications into smaller, independently deployable services, each responsible for a specific business capability. This modular approach improves scalability, fault tolerance, and development velocity. We discuss the principles behind microservices, including bounded contexts, service autonomy, and inter-service communication.",
        },
        {
          title: "Building the Backend with Node.js",
          text:
            "Node.js provides a non-blocking, event-driven architecture ideal for handling concurrent requests in microservices. Learn how to structure your Node.js services for maintainability, using Express.js or Fastify for API routing, and patterns such as service registry and circuit breaker for reliability.",
        },
        {
          title: "Database Strategies with PostgreSQL",
          text:
            "PostgreSQL is a powerful relational database suited for microservices needing strong consistency and complex queries. We explore schema design, indexing strategies, and connection pooling. Additionally, discover how to implement event sourcing and CQRS patterns to improve scalability and data integrity.",
        },
        {
          title: "Performance and Scalability Considerations",
          text:
            "Scaling microservices involves horizontal scaling, load balancing, and database replication. Understand caching strategies with Redis, asynchronous processing with message queues, and monitoring techniques to keep your services performant under heavy loads.",
        },
        {
          title: "Conclusion",
          text:
            "Adopting microservices with Node.js and PostgreSQL enables building resilient, scalable systems. Mastering these architectural patterns and technologies positions you to tackle complex software challenges in modern cloud environments.",
        },
      ],
    },
  },
  {
    ...
    content: {
      intro:
        "React is a powerful library for building user interfaces, but without proper optimization, apps can suffer from slow rendering and sluggish responsiveness. This post shares practical tips drawn from real-world projects to enhance React performance.",
      sections: [
        {
          title: "Avoiding Unnecessary Renders",
          text:
            "React components re-render when their props or state change. Learn to leverage `React.memo`, `useMemo`, and `useCallback` hooks to memoize components and computations, preventing wasteful renders and improving efficiency.",
        },
        {
          title: "Code Splitting and Lazy Loading",
          text:
            "Break your app into smaller bundles using dynamic `import()` and React.lazy to load only the necessary code on demand. This reduces initial load time and speeds up perceived performance, especially for large applications.",
        },
        {
          title: "Optimizing State Management",
          text:
            "Excessive or poorly structured state can degrade performance. Use context sparingly, normalize state shapes, and choose state management libraries like Redux or Zustand wisely. Implement selective subscriptions to minimize component updates.",
        },
        {
          title: "Virtualization for Large Lists",
          text:
            "Rendering thousands of DOM nodes can cripple performance. Implement windowing libraries like react-window or react-virtualized to render only visible portions of lists, drastically reducing memory usage and improving scrolling smoothness.",
        },
        {
          title: "Conclusion",
          text:
            "Performance optimization is critical for delivering smooth and responsive React applications. Applying these tips leads to better user experience and more maintainable codebases.",
        },
      ],
    },
  },
  {
    id: 3,
    title: "Migrating Legacy Systems to Cloud-Native Architecture on GCP",
    img: "/img/pc_blog3.webp",
    date: "28 March 2025",
    content: {
      intro:
        "Migrating legacy applications to a cloud-native architecture unlocks benefits like scalability, cost savings, and faster innovation. This blog post outlines strategies and best practices for migrating systems to Google Cloud Platform (GCP).",
      sections: [
        {
          title: "Assessing Legacy Systems",
          text:
            "Begin with a thorough assessment of your existing system’s architecture, dependencies, and workloads. Identify components suitable for containerization, refactoring, or replacement. Use tools like GCP’s Migrate for Compute Engine to assist with lift-and-shift migrations.",
        },
        {
          title: "Adopting Cloud-Native Principles",
          text:
            "Embrace microservices, container orchestration with Kubernetes, and managed services such as Cloud Run, Pub/Sub, and BigQuery. These enable elastic scalability, fault tolerance, and reduced operational overhead.",
        },
        {
          title: "Migration Patterns and Strategies",
          text:
            "Choose between rehosting, replatforming, or refactoring approaches depending on business needs. Plan data migration carefully to avoid downtime, and use CI/CD pipelines for continuous delivery. Incorporate monitoring and logging with Cloud Monitoring and Cloud Logging.",
        },
        {
          title: "Security and Compliance",
          text:
            "Ensure secure migration by implementing IAM roles, network segmentation, and encryption. Comply with regulatory standards relevant to your industry using GCP’s compliance offerings.",
        },
        {
          title: "Conclusion",
          text:
            "Migrating to cloud-native on GCP requires careful planning and execution but results in modern, scalable applications. Leverage GCP’s ecosystem to accelerate your digital transformation journey.",
        },
      ],
    },
  },
